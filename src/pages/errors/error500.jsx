      ...
      <div className="text-center max-w-2xl">
        <div className="relative mb-8">
          <div className="text-[10rem] sm:text-[12rem] font-black leading-none select-none">
            <span className="absolute inset-0 text-transparent bg-clip-text bg-linear-to-br from-primary/20 to-primary/5 transform rotate-3">500</span>
            <span className="relative text-transparent bg-clip-text bg-linear-to-br from-primary via-primary to-primary/80">500</span>
          </div>
        ...
        <div className="space-y-2 mb-6">
          <h2 className="text-3xl sm:text-4xl font-bold text-base-content">Error intern del servidor</h2>
          <p className="text-base-content/60 text-lg">Alguna cosa no ha funcionat correctament. Mentrestant, pots jugar una mica...</p>
        </div>
