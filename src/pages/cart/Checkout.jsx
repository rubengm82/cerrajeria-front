...
function Checkout() {
  ...
  const stepsDescriptionId = "checkout-steps-description"
  ...
  const content = authLoading || !user || isLoading ? (
    ...
    <>
      <nav className="checkout-page__steps" aria-label="Passos per comprar" aria-describedby={stepsDescriptionId}>
        <p id={stepsDescriptionId} className="checkout-page__sr-only">
          Ara ets al pas d'adreça. Després vindran el pagament i el resum.
        </p>
        <ul className="steps steps-horizontal">
          <li className="step step-primary checkout-page__step" data-content="1" aria-current="step">
            <span>Adreça</span>
            <small>Dades personals i enviament</small>
          </li>
          <li className="step checkout-page__step" data-content="2">
            <span>Pagament</span>
            <small>Afegir mètode de pagament</small>
          </li>
          <li className="step checkout-page__step" data-content="3">
            <span>Resum</span>
            <small>Confirmar comanda</small>
          </li>
        </ul>
      </nav>
