import { HiCurrencyEuro, HiShoppingCart, HiShoppingBag, HiUserGroup } from 'react-icons/hi2'
      ...
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div className="simple-container">
          <div className="flex items-start justify-between">
            ...
            <div className="w-12 h-12 md:w-14 md:h-14 p-2 flex items-center justify-center bg-primary/20 rounded-lg shrink-0">
              <HiShoppingBag className="size-7 md:size-9 text-primary" />
            </div>
        </div>
        ...
        <div className="simple-container">
          <div className="flex items-start justify-between">
            ...
            <div className="w-12 h-12 md:w-14 md:h-14 p-2 flex items-center justify-center bg-primary/20 rounded-lg shrink-0">
              <HiUserGroup className="size-7 md:size-9 text-primary" />
            </div>
          </div>
            ...
            <div className="w-full flex items-center justify-between gap-3">
              <div className="flex items-center gap-3 md:gap-5 min-w-0">
                <div className="bg-primary/20 text-primary flex items-center justify-center rounded-lg w-8 h-8 md:w-10 md:h-10 shrink-0">
                  <HiShoppingBag className="size-5 md:size-7" />
                </div>
